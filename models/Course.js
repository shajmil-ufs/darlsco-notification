...
return db.query("CALL Save_Course_Import("+"@Course_Details :=?"+")",
[JSON.stringify(Course_Details.Course_Import_Details)],callback);
 },
...
//  },
 ...
 Search_Course:function(Course_Name_,Level_Id_,Country_Id_,Internship_Id_,Duration_Id_,University_Id_,Subject_Id_,Sub_Section_Id_,Pointer_Start_,Pointer_Stop_,Page_Length_,callback)
 { 
 if (Course_Name_===undefined || Course_Name_==="undefined" )
Course_Name_='';
...
return db.query("CALL Search_Course(@Course_Name_ :=?,@Level_Id_ :=?,@Country_Id_ :=?,@Internship_Id_ :=?,@Duration_Id_ :=?,@University_Id_ :=?,@Subject_Id_ :=?,@Sub_Section_Id_ :=?,@Pointer_Start_ :=?,@Pointer_Stop_ :=?,@Page_Length_ :=?)",
[Course_Name_,Level_Id_,Country_Id_,Internship_Id_,Duration_Id_,University_Id_,Subject_Id_,Sub_Section_Id_,Pointer_Start_,Pointer_Stop_,Page_Length_],callback);
 },

 Search_Course_Typeahead:function(Country_Id_,Subject_Id_,Sub_Section_Id_,Level_Id_ ,Course_Name_ ,Duration_Id_ ,Ielts_Minimum_Score_ ,Intake_Id_,Internship_Id_,callback)
 { 
     if (Delivery_Point_Name_=== undefined || Delivery_Point_Name_==="undefined")
     Delivery_Point_Name_='';

return db.query("CALL Search_Course_Typeahead(@Country_Id_ :=?,@Subject_Id_ :=?,@Sub_Section_Id_ :=?,@Level_Id_ :=?,@Course_Name_ :=?,@Duration_Id_ :=?,@Ielts_Minimum_Score_ :=?,@Intake_Id_ :=?,@Internship_Id_ :=?)",
[Country_Id_,Subject_Id_,Sub_Section_Id_,Level_Id_ ,Course_Name_ ,Duration_Id_ ,Ielts_Minimum_Score_ ,Intake_Id_,Internship_Id_],callback);
 },
...
{ 
   ...
   Course_Name='';
   return db.query("CALL Search_Courses_Typeahead(@Course_Name :=?)",[Course_Name],callback);
},
