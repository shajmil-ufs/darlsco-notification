...
return {
	...
	Get_Dashboard_Count: async function (Login_User_Id_,FromDate_,ToDate_,Date_Value_) {
		var Leads = [];
...
,
Search_Application_List: function (Fromdate_,Todate_,LoginUser_Id_,Enrolled_Application_Only_View_Permission_,Pointer_Start_,Pointer_Stop_,Page_Length_,Is_View_,Department_Id_,search_name_,look_In_Date_Value, callback) {
	...
	if (
		...
		search_name_ = "";
	return db.query(
		"CALL Search_Application_List(@Fromdate_ :=?,@Todate_ :=?,@LoginUser_Id_ :=?,@Enrolled_Application_Only_View_Permission_ :=?,@Pointer_Start_ :=?,@Pointer_Stop_ :=?,@Page_Length_ :=?,@Is_View_ :=?,@Department_Id_ :=?,@search_name_ :=?,@look_In_Date_Value :=?)",
		[Fromdate_,Todate_,LoginUser_Id_,Enrolled_Application_Only_View_Permission_,Pointer_Start_,Pointer_Stop_,Page_Length_,Is_View_,Department_Id_,search_name_,look_In_Date_Value],
		callback
	);
},
