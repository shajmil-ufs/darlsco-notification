 ...
 //  console.log(User_Details_)
    return new Promise(async (rs, rej) => {
      ...
      try {
       ...
       User_Details_.All_Time_Department_View,All_time_Department_Value_,JSON.stringify(All_Time_Departments_),Country_Value_,JSON.stringify(Country_Data)], connection)).result();
...
Get_User_Type:function(callback)
  ...
  Get_Users_Load_Data: async function () {
   ...
   return { User_Type, User_Menu_Selection, User_Status, Branch, User_Department, Profile_Department, Application_Groups, Application_Statuses ,Call_Status};
 },
...
Get_User_Details_Edit: async function (User_Id_) {
 ...
 return { [0]: { Menu, Department,Applic_Group,Applic_Status,All_time_dept,User_Countries } };
},
