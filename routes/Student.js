...
try 
{
 Student.Save_Profile(req.body, function (err, rows) 
{
if (err) 
{
//
...
router.get("/Transfer_Cofirmation", function (req, res, next) {
    try {
        Student.Transfer_Cofirmation(req.query.Student_Id_,req.query.Transfer_Source_,req.query.Login_User_Id_,req.query.Department_Id_,req.query.Remark_,req.query.Transfer_Status_Id_,req.query.Transfer_Status_Name_,req.query.Sub_Status_Id_,req.query.Sub_Status_Name_,req.query.Application_Id_Ref_, function (err, rows) {
            if (err) {
                res.json(err);
            } else {
                console.log(err)
...
router.get(
    "/Search_Student_Report/:Fromdate_?/:Todate_?/:Search_By_?/:SearchbyName_?/:Department_?/:Enquiry_Source_?/:Branch_?/:By_User_?/:Is_Date_Check_?/:Is_Old_Datas_?/:Page_Index1_?/:Page_Index2_?/:Login_User_Id_?/:RowCount?/:RowCount2?/:remarks_?/:To_User_?/:Status_Id_?/:Register_Value_?",
    async function (req, res, next) {
        var result = "";
        try {
            result = await Student.Search_Student_Report(
...
finally 
{
 ...
 router.get("/Search_Application_List/:Fromdate_?/:Todate_?/:LoginUser_Id_?/:Enrolled_Application_Only_View_Permission_?/:Pointer_Start_?/:Pointer_Stop_?/:Page_Length_?/:Is_View_?/:Department_Id_?/:search_name_?/:look_In_Date_Value?", function (req, res, next) {
    try {
        Student.Search_Application_List(req.params.Fromdate_,req.params.Todate_,req.params.LoginUser_Id_,req.params.Enrolled_Application_Only_View_Permission_,req.params.Pointer_Start_,req.params.Pointer_Stop_,req.params.Page_Length_,req.params.Is_View_,req.params.Department_Id_,req.params.search_name_,req.params.look_In_Date_Value,function (err, rows) {
            if (err) {
                res.json(err);
            } else {
                res.json(rows);
